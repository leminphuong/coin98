  ...
  const courses = [
    {
      ...
      instructor: "Jack Vĩ",
      image:
        "https://files.amberblocks.com/thumbnail/chnbzaa92ook5tnj/courses/cse62xxih5hkocvo/fevyigyl6yooyopwhv1gdvi9h0zmglgy/farming-101-upside.jpg",
      avatar:
        "https://files.amberblocks.com/userdata/usr0edxeyf3hqo4s6a1ubqbbt72p4a0s/profile-pictures/f2ti9xky7rxhlaaqnt2e1009grxhm3l1/photo_2024-06-06_15-46-40.jpg",
    },
    {
      href: "/courses/farming-101",
      title: "Farming 101 - Tối ưu chiến lược farming trong DeFi",
        ...
        <div className="w-full lg:w-w280 sticky lg:relative lg:top-0 bg-background z-10 top-1600 md:top-sp160">
          <div className="lg:pl-1000 lg:py-400 lg:h-full overflow-x-scroll lg:overflow-x-visible no-scrollbar">
            ...
            <div className="lg:sticky flex flex-row lg:flex-col lg:top-sp160">
              {/* ITEM 1 */}
              <div className="px-200 py-100 md:px-300 md:py-200 relative flex flex-none flex-row lg:flex-col group/course-section-menu select-none">
                <div className="p-150 rounded-050 transition-all duration-200 ease-linear bg-menu-item-background">
                  <span className="text-menu-item-text ui-text-medium-emphasis">
                    All courses
                  </span>
                </div>
              ...
              <div className="px-200 py-100 md:px-300 md:py-200 relative flex flex-none flex-row lg:flex-col group/course-section-menu select-none">
                ...
                <div className="p-150 rounded-050 transition-all duration-200 ease-linear lg:hover:bg-menu-item-background">
                  <span className="text-menu-item-text ui-text-medium">
                    Khoá học
                  </span>
                </div>
