...
export interface ArticleCardVerticalLargeProps {
  slug: string;
  title: string;
  excerpt: string;
  image: string;
  ...
  return (
    <Link href={`/${slug}`}>
      ...
      >
        ...
        {/* AUTHOR */}
        <div className="ui-text-small text-text-secondary min-h-300 flex-wrap items-center lg:mb-150 mb-100 lg:flex hidden">
